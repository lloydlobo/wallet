...
// FIXME: The title is overiding any parent <title> or title="" attribute on hover.
//
// https://docs.rome.tools/lint/rules/nosvgwithouttitle/

export function UserIcon(props: JSX.IntrinsicAttributes & JSX.SvgSVGAttributes<SVGSVGElement>) {
  return (
...
export function SaveIcon(props: JSX.IntrinsicAttributes & JSX.SvgSVGAttributes<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <title class="sr-only">SaveIcon</title>
...
export function CalendarIcon(props: JSX.IntrinsicAttributes & JSX.SvgSVGAttributes<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <title class="sr-only">CalendarIcon</title>
